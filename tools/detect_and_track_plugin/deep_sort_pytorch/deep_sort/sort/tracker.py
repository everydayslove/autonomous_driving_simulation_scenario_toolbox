...
class Tracker:
    ...
    def update(self, detections):
        ...
        matches, unmatched_tracks, unmatched_detections, t77, t78 = self._match(detections)
    ...
    def _match(self, detections):
        ...
        matches_a, unmatched_tracks_a, unmatched_detections, t77, t78 = \
        ...
        return matches, unmatched_tracks, unmatched_detections, t77, t78

    def _initiate_track(self, detection):
        mean, covariance = self.kf.initiate(detection.to_xyah_theta())
        self.tracks.append(Track(mean, covariance, self._next_id, self.n_init, self.max_age, detection.feature, detection.attrs))
        self._next_id += 1
